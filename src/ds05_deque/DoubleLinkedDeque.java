/*
 * 1. Doubly Linked List Deque:
 * 	- double linked list đã implement các method của Deque, ta chỉnh đơn giản tuyên
 * 		bố thêm implements Deque
 * 
 * 2. Các thao tác:
 ...
 * 
 * 3. Tốt:
 * 	-- Tận dụng được performance cao của DLL
 * 
 * 4. Xấu:
 * 	-- Tốn bộ nhớ do DLL có tới 2 tham chiếu prev, next
 * 
 * 5. Ứng dụng:
 * 	-- Double Linked List Deque là ứng dụng thực tế của DLL 
 */
