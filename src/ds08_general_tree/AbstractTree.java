/*
 * 1. AbstractTree: 
 * 	-- Là lớp abstract general tree 
 * 2. Các thao tác:
 * 	-- O(1)	: isInternal(), isExternal(), isRoot(), size(), isEmpty()
 * 	-- O(n)	: depth(), height(), preorder(), postorder(), breadthfirst()
 * 		
 */
...
import ds04_queue.LinkedQueue;
import ds04_queue.Queue;
